  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        alert('Failed to parse the generated interview questions. Please try again.');
        setLoading(false);
        return;
      }
      ...
      try {
        ...
        alert('There was an error saving the interview details. Please try again later.');
      }

    } catch (error) {
      console.error('❌ Error generating interview questions:', error);
      alert('Failed to generate interview questions from AI. Please try again.');
    }
